...
public class Grammar {
    ...
    public Grammar(ArrayList<String> vn, ArrayList<String> vt,
    ...
    /**
     * Retorna todas as produções de um simbolo não terminal dado.
     *
     * @param nt	Simbolo não terminal que se quer saber as produções.
     * @return	Lista contendo as produções do simbolo não terminal dado.
     */
    ...
    /**
     * Função usada para achar o first de uma sentença de uma produção da
     * gramatica.
     *
    ...
    /**
     * Função usada para achar o firstNT de uma sentença de uma produção da
     * gramatica.
     *
